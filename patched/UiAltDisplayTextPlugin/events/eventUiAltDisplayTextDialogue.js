...
const textDialogue = (
    ...
    const { _callNative, options, _addComment, _stackPushConst, _getMemUInt8, _setConstMemUInt8,
    _overlayClear, _overlayMoveTo, _overlaySetScroll, _getAvatarCode, _injectScrollCode, _overlayWait,
